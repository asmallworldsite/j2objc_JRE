...
/*!
 @brief If a hostname is not a key in the EXCLUDE map, and if removing its leftmost component results
...
/*!
 @brief The elements in this map would pass the UNDER test, but are known not to be public suffixes and
  are thus excluded from consideration.Since it refers to elements in UNDER of the same type,
  the type is actually not important here.
