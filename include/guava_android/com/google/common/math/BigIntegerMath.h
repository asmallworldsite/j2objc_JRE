...
/*!
 ...
 <p>For the case of <code>RoundingMode.HALF_DOWN</code>, <code>HALF_UP</code>, and <code>HALF_EVEN</code>,
  ...
  representable as a double, but <code>roundToDouble(BigInteger.valueOf(2).pow(2000), HALF_UP)</code>
 ...
 @since 30.0
 */
+ (jdouble)roundToDoubleWithJavaMathBigInteger:(JavaMathBigInteger * __nonnull)x
                      withJavaMathRoundingMode:(JavaMathRoundingMode * __nonnull)mode;
...
FOUNDATION_EXPORT jdouble ComGoogleCommonMathBigIntegerMath_roundToDoubleWithJavaMathBigInteger_withJavaMathRoundingMode_(JavaMathBigInteger *x, JavaMathRoundingMode *mode);
