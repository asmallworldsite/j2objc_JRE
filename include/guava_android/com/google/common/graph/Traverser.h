...
/*!
 @brief Abstracts away the difference between traversing a graph vs.a tree.
 For a tree, we just take
...
- (instancetype __nonnull)initWithComGoogleCommonGraphSuccessorsFunction:(id<ComGoogleCommonGraphSuccessorsFunction> __nonnull)successorFunction;

- (id<JavaUtilIterator>)breadthFirstWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)startNodes;

+ (ComGoogleCommonGraphTraverser_Traversal *)inGraphWithComGoogleCommonGraphSuccessorsFunction:(id<ComGoogleCommonGraphSuccessorsFunction> __nonnull)graph;

+ (ComGoogleCommonGraphTraverser_Traversal *)inTreeWithComGoogleCommonGraphSuccessorsFunction:(id<ComGoogleCommonGraphSuccessorsFunction> __nonnull)tree;

- (id<JavaUtilIterator>)postOrderWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)startNodes;

- (id<JavaUtilIterator>)preOrderWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)startNodes;

/*!
 @brief Visits the next node from the top iterator of <code>horizon</code> and returns the visited node.
 Null is returned to indicate reaching the end of the top iterator. 
 <p>For example, if horizon is <code>[[a, b], [c, d], [e]]</code>, <code>visitNext()</code> will return 
 <code>[a, b, null, c, d, null, e, null]</code> sequentially, encoding the topological structure.
  (Note, however, that the callers of <code>visitNext()</code> often insert additional iterators
  into <code>horizon</code> between calls to <code>visitNext()</code>. This causes them to receive
  additional values interleaved with those shown above.)
 */
- (id __nullable)visitNextWithJavaUtilDeque:(id<JavaUtilDeque> __nonnull)horizon;
