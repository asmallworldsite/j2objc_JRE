...
/*!
 @brief Returns the given <code>template</code> string with each occurrence of <code>"%s"</code> replaced with
  ...
  normal conditions.
 <p><b>Note:</b> For most string-formatting needs, use <code>String.format</code>,
  <code>PrintWriter.format</code>, and related methods. These support the
  full range of <a href="https://docs.oracle.com/javase/9/docs/api/java/util/Formatter.html#syntax">
 format
  specifiers</a>, and alert you to usage errors by throwing <code>java.util.IllegalFormatException</code>
 .
