...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/base/Functions.java
//
 ...
 */
+ (id<ComGoogleCommonBaseFunction>)constantWithId:(id __nullable)value;
...
/*!
 ...
 <p><b>Java 8 users:</b> you can just write the lambda expression <code>k ->
  map.getOrDefault(k, defaultValue)</code>
  instead.
