 ...
 */
+ (id __nonnull)checkNotNullWithId:(id __nonnull)reference;
...
/*!
 ...
 @since 20.0 (varargs overload since 2.0)
 */
+ (id __nonnull)checkNotNullWithId:(id __nonnull)obj
                      withNSString:(NSString * __nullable)errorMessageTemplate
                          withChar:(jchar)p1;
...
/*!
 @brief Ensures that <code>start</code> and <code>end</code> specify valid <i>positions</i> in an array, list or
  string of size <code>size</code>, and are in order.A position index may range from zero to <code>size</code>
 , inclusive.
