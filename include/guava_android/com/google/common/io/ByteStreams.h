...
/*!
 ...
 @since 17.0
 */
+ (id<ComGoogleCommonIoByteArrayDataOutput>)newDataOutputWithJavaIoByteArrayOutputStream:(JavaIoByteArrayOutputStream * __nonnull)byteArrayOutputStream OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @throw IOExceptionif an I/O error occurs
 @throw IndexOutOfBoundsExceptionif <code>off</code> is negative, if <code>len</code> is negative, or if
...
FOUNDATION_EXPORT id<ComGoogleCommonIoByteArrayDataOutput> ComGoogleCommonIoByteStreams_newDataOutputWithJavaIoByteArrayOutputStream_(JavaIoByteArrayOutputStream *byteArrayOutputStream);
