...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/io/ByteSource.java
//
...
/*!
 ...
 <p>Note that the given byte array may be be passed directly to methods on, for example, <code>OutputStream</code>
  (when <code>copyTo(OutputStream)</code> is called on the resulting <code>ByteSource</code>
 ). This could allow a malicious <code>OutputStream</code> implementation to modify the
