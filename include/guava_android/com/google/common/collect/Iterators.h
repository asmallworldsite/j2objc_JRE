...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/collect/Iterators.java
//
...
+ (jboolean)addAllWithJavaUtilCollection:(id<JavaUtilCollection> __nonnull)addTo
                    withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
 ...
 */
+ (jint)advanceWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
 ...
 */
+ (jboolean)allWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
...
/*!
 @brief Returns <code>true</code> if one or more elements returned by <code>iterator</code> satisfy the given
  predicate.
 */
+ (jboolean)anyWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
   withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;
 ...
 */
+ (id<JavaUtilEnumeration>)asEnumerationWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
 ...
 */
+ (id<JavaUtilIterator>)concatWithJavaUtilIteratorArray:(IOSObjectArray * __nonnull)inputs;
 ...
 */
+ (id<JavaUtilIterator>)concatWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)inputs;
...
/*!
 ...
 <p>The returned iterator supports <code>remove()</code> when the corresponding input iterator
  supports it.
 */
+ (id<JavaUtilIterator>)concatWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)a
                              withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)b;
...
+ (id<JavaUtilIterator>)concatWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)a
                              withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)b
                              withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)c;
...
+ (id<JavaUtilIterator>)concatWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)a
                              withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)b
                              withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)c
                              withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)d;
...
/*!
 ...
 @since 2.0
 */
+ (id<JavaUtilIterator>)consumingIteratorWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;

/*!
 @brief Returns <code>true</code> if <code>iterator</code> contains <code>element</code>.
 */
+ (jboolean)containsWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
...
/*!
 ...
 <p><b>Warning:</b> Typical uses of the resulting iterator may produce an infinite loop. You
  ...
  elements.
 */
+ (id<JavaUtilIterator>)cycleWithJavaLangIterable:(id<JavaLangIterable> __nonnull)iterable;
...
/*!
 ...
 <p><b>Warning:</b> Typical uses of the resulting iterator may produce an infinite loop. You
  ...
  elements.
 */
+ (id<JavaUtilIterator>)cycleWithNSObjectArray:(IOSObjectArray * __nonnull)elements;
 ...
 */
+ (jboolean)elementsEqualWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator1
                         withJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator2;

/*!
 @brief Returns a view of <code>unfiltered</code> containing all elements that are of the type <code>desiredType</code>
 .
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)filterWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)unfiltered
 ...
 */
+ (id)findWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;
...
/*!
 ...
 @since 7.0
 */
+ (id __nullable)findWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
         withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate
 ...
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)forArrayWithNSObjectArray:(IOSObjectArray * __nonnull)array;
...
/*!
 ...
 <p><b>Java 9 users:</b> use <code>enumeration.asIterator()</code> instead, unless it is important to
  return an <code>UnmodifiableIterator</code> instead of a plain <code>Iterator</code>.
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)forEnumerationWithJavaUtilEnumeration:(id<JavaUtilEnumeration> __nonnull)enumeration;
 ...
 */
+ (jint)frequencyWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                               withId:(id __nullable)element;
 ...
 */
+ (id)getWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
...
/*!
 ...
 @since 4.0
 */
+ (id __nullable)getWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                                 withInt:(jint)position
                                  withId:(id __nullable)defaultValue;
 ...
 */
+ (id)getLastWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
...
/*!
 ...
 @since 3.0
 */
+ (id __nullable)getLastWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                                      withId:(id __nullable)defaultValue;
...
/*!
 ...
 @since 7.0
 */
+ (id __nullable)getNextWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                                      withId:(id __nullable)defaultValue;
 ...
 */
+ (id)getOnlyElementWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
...
/*!
 ...
 @throw IllegalArgumentExceptionif the iterator contains multiple elements. The state of the
      iterator is unspecified.
 */
+ (id __nullable)getOnlyElementWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                                             withId:(id __nullable)defaultValue;
...
/*!
 ...
 @since 2.0
 */
+ (jint)indexOfWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
   withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;
...
/*!
 ...
 @since 3.0
 */
+ (id<JavaUtilIterator>)limitWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
...
/*!
 ...
 @since 11.0
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)mergeSortedWithJavaLangIterable:(id<JavaLangIterable> __nonnull)iterators
 ...
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)paddedPartitionWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                                                                            withInt:(jint)size;
...
/*!
 ...
 @throw IllegalArgumentExceptionif <code>size</code> is nonpositive
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)partitionWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                                                                      withInt:(jint)size;
 ...
 */
+ (id<ComGoogleCommonCollectPeekingIterator>)peekingIteratorWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;

/*!
 @brief Simply returns its argument.
 @since 10.0
 */
+ (id<ComGoogleCommonCollectPeekingIterator>)peekingIteratorWithComGoogleCommonCollectPeekingIterator:(id<ComGoogleCommonCollectPeekingIterator> __nonnull)iterator __attribute__((deprecated));
 ...
 */
+ (jboolean)removeAllWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)removeFrom
...
/*!
 ...
 @since 2.0
 */
+ (jboolean)removeIfWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)removeFrom
        withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;
...
/*!
 ...
 @return <code>true</code> if any element was removed from <code>iterator</code>
 */
+ (jboolean)retainAllWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)removeFrom
 ...
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)singletonIteratorWithId:(id __nullable)value;

/*!
 @brief Returns the number of elements remaining in <code>iterator</code>.The iterator will be left
  exhausted: its <code>hasNext()</code> method will return <code>false</code>.
 */
+ (jint)sizeWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
 ...
 */
+ (IOSObjectArray *)toArrayWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
 ...
 */
+ (NSString *)toStringWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
...
/*!
 ...
 <p>The returned iterator supports <code>remove()</code> if <code>fromIterator</code> does. After a
  ...
  element.
 */
+ (id<JavaUtilIterator>)transformWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)fromIterator
...
/*!
 ...
 @since 11.0
 */
+ (ComGoogleCommonBaseOptional *)tryFindWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator
                            withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;

/*!
 @brief Returns an unmodifiable view of <code>iterator</code>.
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)unmodifiableIteratorWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;

/*!
 @brief Simply returns its argument.
 @since 10.0
 */
+ (ComGoogleCommonCollectUnmodifiableIterator *)unmodifiableIteratorWithComGoogleCommonCollectUnmodifiableIterator:(ComGoogleCommonCollectUnmodifiableIterator * __nonnull)iterator __attribute__((deprecated));
...
/*!
 ...
 bug_id=6558557
 */
+ (id<JavaUtilListIterator>)castWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
 ...
 */
+ (void)clearWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;

/*!
 @brief Concats a varargs array of iterators without making a defensive copy of the array.
 */
+ (id<JavaUtilIterator>)concatNoDefensiveCopyWithJavaUtilIteratorArray:(IOSObjectArray * __nonnull)inputs;
...
/*!
 ...
 .
 */
+ (ComGoogleCommonCollectUnmodifiableListIterator *)forArrayWithNSObjectArray:(IOSObjectArray * __nonnull)array
                                                                      withInt:(jint)offset
                                                                      withInt:(jint)length
                                                                      withInt:(jint)index;
...
/*!
 @brief Deletes and returns the next value from the iterator, or returns <code>null</code> if there is no
  such value.
 */
+ (id __nullable)pollNextWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;
