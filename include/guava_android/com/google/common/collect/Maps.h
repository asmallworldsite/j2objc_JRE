...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/collect/Maps.java
//
...
+ (id __nullable)keyOrNullWithJavaUtilMap_Entry:(id<JavaUtilMap_Entry> __nullable)entry_;
...
+ (id __nullable)valueOrNullWithJavaUtilMap_Entry:(id<JavaUtilMap_Entry> __nullable)entry_;
