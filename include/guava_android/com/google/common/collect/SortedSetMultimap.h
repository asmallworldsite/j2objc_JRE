...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/collect/SortedSetMultimap.java
//
...
/*!
 ...
 <p><b>Note:</b> The returned map's values are guaranteed to be of type <code>SortedSet</code>. To
  ...
  instead. <b>However</b>, the returned map <i>itself</i> is
  not necessarily a <code>SortedMap</code>: A <code>SortedSetMultimap</code> must expose the <i>values</i>
  for a given key in sorted order, but it need not expose the <i>keys</i> in sorted order.
  Individual <code>SortedSetMultimap</code> implementations, like those built with <code>MultimapBuilder.treeKeys()</code>
