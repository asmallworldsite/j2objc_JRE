...
/*!
 @brief Returns an <code>ImmutableList</code> containing all of the elements from this fluent iterable in
  proper sequence.
 <p><b><code>Stream</code> equivalent:</b> <code>ImmutableList.copyOf(stream.iterator())</code>, or pass 
 <code>ImmutableList.toImmutableList</code> to <code>stream.collect()</code>.
...
/*!
 ...
 <p><b><code>Stream</code> equivalent:</b> use <code>stream.collect(ImmutableMap.toImmutableMap(k ->
  k, valueFunction))</code>
 . <code>ImmutableMap.copyOf(stream.collect(Collectors.toMap(k -> k,
  valueFunction)))</code>
  behaves similarly, but may not preserve the order of entries.
...
/*!
 ...
 <p><b><code>Stream</code> equivalent:</b> <code>ImmutableMultiset.copyOf(stream.iterator())</code>, or
  pass <code>ImmutableMultiset.toImmutableMultiset</code> to <code>stream.collect()</code>.
...
/*!
 @brief Returns an <code>ImmutableSet</code> containing all of the elements from this fluent iterable with
  duplicates removed.
 <p><b><code>Stream</code> equivalent:</b> <code>ImmutableSet.copyOf(stream.iterator())</code>, or pass 
 <code>ImmutableSet.toImmutableSet</code> to <code>stream.collect()</code>.
 @throw NullPointerExceptionif any element is <code>null</code>
...
/*!
 ...
 , or pass <code>ImmutableList.toImmutableList</code>
  to <code>stream.sorted(comparator).collect()</code>.
...
/*!
 ...
 , or pass <code>ImmutableSortedSet.toImmutableSortedSet</code> to <code>stream.collect()</code>
 .
...
@endcode
 ...
 <p><b><code>Stream</code> equivalent:</b> use <code>stream.collect(ImmutableMap.toImmutableMap(keyFunction, v -> v))</code>
 . <code>ImmutableMap.copyOf(stream.collect(Collectors.toMap(keyFunction, v -> v)))</code>
 , but be aware that
