...
//  source: /Users/tball/src/j2objc/guava/android/build_result/java/com/google/common/collect/ImmutableList.java
//
...
- (void)addWithInt:(jint)index
            withId:(id __nonnull)element __attribute__((deprecated));
...
- (jboolean)addAllWithInt:(jint)index
   withJavaUtilCollection:(id<JavaUtilCollection> __nonnull)newElements __attribute__((deprecated));
 ...
 */
+ (ComGoogleCommonCollectImmutableList *)copyOfWithJavaUtilCollection:(id<JavaUtilCollection> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @since 3.0
 */
+ (ComGoogleCommonCollectImmutableList *)copyOfWithNSObjectArray:(IOSObjectArray * __nonnull)elements OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @throw NullPointerExceptionif <code>elements</code> contains a null element
 */
+ (ComGoogleCommonCollectImmutableList *)copyOfWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements OBJC_METHOD_FAMILY_NONE;

/*!
 @brief Returns an immutable list containing the given elements, in order.
 @throw NullPointerExceptionif <code>elements</code> contains a null element
 */
+ (ComGoogleCommonCollectImmutableList *)copyOfWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
...
/*!
 @brief Returns an immutable list containing a single element.This list behaves and performs
  comparably to <code>Collections.singletonList</code>, but will not accept a null element.
 It is
  preferable mainly for consistency and maintainability of your code.
 @throw NullPointerExceptionif <code>element</code> is null
 */
+ (ComGoogleCommonCollectImmutableList *)ofWithId:(id __nonnull)element;

/*!
 @brief Returns an immutable list containing the given elements, in order.
 @throw NullPointerExceptionif any element is null
 */
+ (ComGoogleCommonCollectImmutableList *)ofWithId:(id __nonnull)e1
...
/*!
 ...
 @since 21.0
 */
+ (ComGoogleCommonCollectImmutableList *)sortedCopyOfWithJavaUtilComparator:(id<JavaUtilComparator> __nonnull)comparator
...
/*!
 ...
 @since 21.0
 */
+ (ComGoogleCommonCollectImmutableList *)sortedCopyOfWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements;
 ...
 */
+ (ComGoogleCommonCollectImmutableList *)asImmutableListWithNSObjectArray:(IOSObjectArray * __nonnull)elements;

/*!
 @brief Views the array as an immutable list.Does not check for nulls.
 */
+ (ComGoogleCommonCollectImmutableList *)asImmutableListWithNSObjectArray:(IOSObjectArray * __nonnull)elements
                                                                  withInt:(jint)length;
...
#if !defined (ComGoogleCommonCollectImmutableList_Itr_) && (INCLUDE_ALL_ComGoogleCommonCollectImmutableList || defined(INCLUDE_ComGoogleCommonCollectImmutableList_Itr))
#define ComGoogleCommonCollectImmutableList_Itr_

#define RESTRICT_ComGoogleCommonCollectAbstractIndexedListIterator 1
#define INCLUDE_ComGoogleCommonCollectAbstractIndexedListIterator 1
#include "com/google/common/collect/AbstractIndexedListIterator.h"

@class ComGoogleCommonCollectImmutableList;

@interface ComGoogleCommonCollectImmutableList_Itr : ComGoogleCommonCollectAbstractIndexedListIterator
...
- (instancetype __nonnull)initWithComGoogleCommonCollectImmutableList:(ComGoogleCommonCollectImmutableList * __nonnull)list
                                                              withInt:(jint)index;
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonCollectImmutableList_Itr)

FOUNDATION_EXPORT void ComGoogleCommonCollectImmutableList_Itr_initWithComGoogleCommonCollectImmutableList_withInt_(ComGoogleCommonCollectImmutableList_Itr *self, ComGoogleCommonCollectImmutableList *list, jint index);

FOUNDATION_EXPORT ComGoogleCommonCollectImmutableList_Itr *new_ComGoogleCommonCollectImmutableList_Itr_initWithComGoogleCommonCollectImmutableList_withInt_(ComGoogleCommonCollectImmutableList *list, jint index) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectImmutableList_Itr *create_ComGoogleCommonCollectImmutableList_Itr_initWithComGoogleCommonCollectImmutableList_withInt_(ComGoogleCommonCollectImmutableList *list, jint index);

J2OBJC_TYPE_LITERAL_HEADER(ComGoogleCommonCollectImmutableList_Itr)
...
- (instancetype __nonnull)initWithComGoogleCommonCollectImmutableList:(ComGoogleCommonCollectImmutableList * __nonnull)outer$
                                                              withInt:(jint)offset
                                                              withInt:(jint)length;
...
- (instancetype __nonnull)initWithNSObjectArray:(IOSObjectArray * __nonnull)elements;
...
/*!
 ...
 @throw NullPointerExceptionif <code>element</code> is null
 */
- (ComGoogleCommonCollectImmutableList_Builder *)addWithId:(id __nonnull)element;
 ...
 */
- (ComGoogleCommonCollectImmutableList_Builder *)addWithNSObjectArray:(IOSObjectArray * __nonnull)elements;
...
/*!
 ...
 @throw NullPointerExceptionif <code>elements</code> is null or contains a null element
 */
- (ComGoogleCommonCollectImmutableList_Builder *)addAllWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements;

/*!
 @brief Adds each element of <code>elements</code> to the <code>ImmutableList</code>.
 @param elements the <code>Iterator</code>  to add to the <code>ImmutableList</code>
 @return this <code>Builder</code> object
 @throw NullPointerExceptionif <code>elements</code> is null or contains a null element
 */
- (ComGoogleCommonCollectImmutableList_Builder *)addAllWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)elements;
