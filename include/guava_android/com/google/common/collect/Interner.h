...
/*!
 @brief Provides similar behavior to <code>String.intern</code> for any immutable type.Common implementations
  are available from the <code>Interners</code> class.
 <p>Note that <code>String.intern()</code> has some well-known performance limitations, and should
  generally be avoided. Prefer <code>Interners.newWeakInterner</code> or another <code>Interner</code>
  implementation even for <code>String</code> interning.
