...
/*!
 @brief Returns a hash table for the specified keys and values, and ensures that neither keys nor
  values are null.
 */
+ (id)createHashTableWithNSObjectArray:(IOSObjectArray * __nonnull)alternatingKeysAndValues
                               withInt:(jint)n
...
+ (id)getWithId:(id __nullable)hashTableObject
...
FOUNDATION_EXPORT id ComGoogleCommonCollectRegularImmutableMap_createHashTableWithNSObjectArray_withInt_withInt_withInt_(IOSObjectArray *alternatingKeysAndValues, jint n, jint tableSize, jint keyOffset);
