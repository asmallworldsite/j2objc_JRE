...
/*!
 ...
 <p><b>Note:</b> Consider using <code>Comparators.max(a, b, thisComparator)</code> instead. If <code>thisComparator</code>
  is <code>Ordering.natural</code>, then use <code>Comparators.max(a, b)</code>.
...
/*!
 ...
 <p><b>Java 8 users:</b> If <code>iterable</code> is a <code>Collection</code>, use <code>Collections.max(collection, thisComparator)</code>
  instead. Otherwise, use <code>Streams.stream(iterable).max(thisComparator).get()</code>
...
/*!
 ...
 <p><b>Java 8 users:</b> Use <code>Streams.stream(iterator).max(thisComparator).get()</code> instead
...
/*!
 ...
 <p><b>Note:</b> Consider using <code>Comparators.min(a, b, thisComparator)</code> instead. If <code>thisComparator</code>
  is <code>Ordering.natural</code>, then use <code>Comparators.min(a, b)</code>.
...
/*!
 ...
 <p><b>Java 8 users:</b> If <code>iterable</code> is a <code>Collection</code>, use <code>Collections.min(collection, thisComparator)</code>
  instead. Otherwise, use <code>Streams.stream(iterable).min(thisComparator).get()</code>
  instead. Note that these alternatives do
...
/*!
 ...
 <p><b>Java 8 users:</b> Use <code>Streams.stream(iterator).min(thisComparator).get()</code> instead
