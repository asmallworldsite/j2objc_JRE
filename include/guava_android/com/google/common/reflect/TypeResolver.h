...
/*!
 ...
 <p>For example, when resolving <code>List<T></code> in the context of <code>ArrayList<?></code>, <code><T></code>
  is covariantly resolved to <code><?></code> such that return type of <code>List::get</code> is 
 <code><?></code>.
 */
...
/*!
 ...
 <p>For example, when resolving <code>List<T></code> in the context of <code>ArrayList<?></code>, <code><T></code>
  cannot be invariantly resolved to <code><?></code> because otherwise the parameter type of 
 <code>List::set</code> will be <code><?></code> and it'll falsely say any object can be passed into 
 <code>ArrayList<?>::set</code>.
  
 <p>Instead, <code><?></code> will be resolved to a capture in the form of a type variable <code><capture-of-? extends Object></code>
 , effectively preventing <code>set</code> from accepting any type.
 */
