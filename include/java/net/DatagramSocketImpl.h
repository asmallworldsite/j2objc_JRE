...
@interface JavaNetDatagramSocketImpl : NSObject < JavaNetSocketOptions > {
 @public
  ...
  /*!
   @brief The DatagramSocket or MulticastSocket
  that owns this impl
   */
  WEAK_ JavaNetDatagramSocket *socket_;
}
...
/*!
 ...
 @return an <code>int</code> representing the local port value
 */
- (jint)getLocalPort;
...
- (void)setDatagramSocketWithJavaNetDatagramSocket:(JavaNetDatagramSocket *)socket;

- (void)setOptionWithJavaNetSocketOption:(id<JavaNetSocketOption>)name
                                  withId:(id)value;
