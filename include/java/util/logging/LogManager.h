...
/*!
 @brief Returns the global LogManager object.
...
- (JavaUtilLoggingLogManager_LoggerContext *)getSystemContext;
...
- (JavaUtilLoggingLogger *)getGlobalLogger;

- (id<JavaUtilEnumeration>)getLoggerNames;

- (JavaUtilLoggingLogManager_LogNode *)getNodeWithNSString:(NSString *)name;

- (JavaUtilLoggingLogManager *)getOwner;

- (JavaUtilLoggingLogger *)getRootLogger;

- (void)removeLoggerRefWithNSString:(NSString *)name
withJavaUtilLoggingLogManager_LoggerWeakRef:(JavaUtilLoggingLogManager_LoggerWeakRef *)ref;

- (jboolean)requiresDefaultLoggers;
...
FOUNDATION_EXPORT void JavaUtilLoggingLogManager_SystemLoggerContext_initWithJavaUtilLoggingLogManager_(JavaUtilLoggingLogManager_SystemLoggerContext *self, JavaUtilLoggingLogManager *outer$);

FOUNDATION_EXPORT JavaUtilLoggingLogManager_SystemLoggerContext *new_JavaUtilLoggingLogManager_SystemLoggerContext_initWithJavaUtilLoggingLogManager_(JavaUtilLoggingLogManager *outer$) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaUtilLoggingLogManager_SystemLoggerContext *create_JavaUtilLoggingLogManager_SystemLoggerContext_initWithJavaUtilLoggingLogManager_(JavaUtilLoggingLogManager *outer$);
...
@interface JavaUtilLoggingLogManager_LogNode : NSObject {
 @public
  ...
  WEAK_ JavaUtilLoggingLogManager_LoggerContext *context_;
}
