...
//  source: /Users/tball/src/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/DTM.java
//
...
/*!
 @brief <code>DTM</code> is an XML document model expressed as a table
  rather than an object tree.It attempts to provide an interface to
  a parse tree that has very little object creation.
 (DTM
...
/*!
 @brief This is a shortcut to the iterators that implement
  XPath axes.
...
/*!
 @brief Given a node handle, get the handle of the node's last child.
 @param nodeHandle int Handle of the node.
...
/*!
 @brief Retrieves an attribute node by local name and namespace URI
...
/*!
 @brief Given a node handle, get the index of the node's first namespace node.
...
/*!
 @brief Given a namespace handle, advance to the next namespace in the same scope
  (local or local-plus-inherited, as selected by getFirstNamespaceNode)
 @param baseHandle handle to original node from where the first child  was relative to (needed to return nodes in document order).
...
/*!
 @brief Given a DTM which contains only a single document, 
  ...
  documents.
 Generally, you should use getOwnerDocument(nodeHandle)
...
/*!
 ...
 - seealso: #getOwnerDocument(int nodeHandle)
 */
...
/*!
 ...
 @param startAndLen A two-integer array which, upon return, WILL  BE FILLED with values representing the chunk's start position
...
/*!
 @brief 2.
 [element content whitespace] A boolean indicating whether a
...
/*!
 @brief Directly create SAX parser events representing the XML content of
...
/*!
 @brief Return this DTM's content handler, if it has one.
 @return null if this model doesn't respond to SAX events.
 */
- (id<OrgXmlSaxContentHandler>)getContentHandler;

/*!
 @brief Return this DTM's lexical handler, if it has one.
...
/*!
 @brief Return this DTM's EntityResolver, if it has one.
 @return null if this model doesn't respond to SAX entity ref events.
 */
- (id<OrgXmlSaxEntityResolver>)getEntityResolver;

/*!
 @brief Return this DTM's DTDHandler, if it has one.
 @return null if this model doesn't respond to SAX dtd events.
 */
- (id<OrgXmlSaxDTDHandler>)getDTDHandler;

/*!
 @brief Return this DTM's ErrorHandler, if it has one.
 @return null if this model doesn't respond to SAX error events.
 */
- (id<OrgXmlSaxErrorHandler>)getErrorHandler;

/*!
 @brief Return this DTM's DeclHandler, if it has one.
 @return null if this model doesn't respond to SAX Decl events.
 */
- (id<OrgXmlSaxExtDeclHandler>)getDeclHandler;

/*!
 @brief Append a child to "the end of the document".Please note that
...
/*!
 @brief Get the location of a node in the source document.
...
/*!
 @brief As the DTM is registered with the DTMManager, this method
...
/*!
 @brief As documents are released from the DTMManager, the DTM implementation
...
@interface OrgApacheXmlDtmDTM : NSObject
@property (readonly, class) jint NULL_ NS_SWIFT_NAME(NULL_);
@property (readonly, class) jshort ROOT_NODE NS_SWIFT_NAME(ROOT_NODE);
...
@property (readonly, class) jshort NAMESPACE_NODE NS_SWIFT_NAME(NAMESPACE_NODE);
@property (readonly, class) jshort NTYPES NS_SWIFT_NAME(NTYPES);
...
/*!
 @brief Null node handles are represented by this value.
 */
...
/*!
 @brief The node is a <code>Root</code>.
 */
...
/*!
 @brief The node is a <code>namespace node</code>.Note that this is not
...
/*!
 @brief The number of valid nodetypes.
 */
