...
@endcode
 ...
 - seealso: <a href="https://github.com/junit-team/junit4/wiki/Theories">Theories</a>
 @since 4.4
 */
...
/*!
 @brief Attempts to halt the test and ignore it if Throwable <code>e</code> is
...
/*!
 @brief Use to assume that an operation completes normally.If <code>e</code> is non-null, the test will halt and be ignored.
 For example: 
 @code
...
/*!
 @brief If called with a <code>null</code> array or one or more <code>null</code> elements in <code>objects</code>,
