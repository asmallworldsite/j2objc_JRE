...
/*!
 @brief Always returns a runner for the given test class.
 ...
 <code>null</code> from this method, but no RunnerBuilder passed to a Runner constructor will
  return <code>null</code> from this method.
 @param testClass class to be run
 @return a Runner
 */
