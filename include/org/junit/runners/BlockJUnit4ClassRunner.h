...
/*!
 ...
 <li>It is published, and extension and reuse are encouraged, whereas <code>JUnit4ClassRunner</code>
  ...
  <p>
  In turn, in 2009 we introduced <code>Rule</code>s.  In many cases where extending
  BlockJUnit4ClassRunner was necessary to add new behavior, <code>Rule</code>s can
...
/*!
 @brief Creates a BlockJUnit4ClassRunner to run <code>testClass</code>
...
/*!
 @brief Returns a new fixture to run a particular test <code>method</code> against.
 Default implementation executes the no-argument <code>createTest()</code> method.
 @since 4.13
 */
...
/*!
 @brief Evaluates whether <code>FrameworkMethod</code>s are ignored based on the 
...
/*!
 ...
 <ul>
  <li>Invoke <code>method</code> on the result of <code>createTest(org.junit.runners.model.FrameworkMethod)</code>, and
  throw any exceptions thrown by either operation. 
 <li>HOWEVER, if <code>method</code>'s <code>@@Test</code> annotation has the <code>Test.expected()</code>
...
/*!
 @brief Returns a <code>Statement</code>: if <code>method</code>'s <code>@@Test</code> annotation
  has the <code>Test.expected()</code> attribute, return normally only if <code>next</code>
