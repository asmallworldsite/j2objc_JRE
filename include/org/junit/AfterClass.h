...
/*!
 @brief If you allocate expensive external resources in a <code>org.junit.BeforeClass</code> method you need to release them
  after all the tests in the class have run.Annotating a <code>public static void</code> method
  with <code>&#064;AfterClass</code> causes that method to be run after all the tests in the class have been run.
 All <code>&#064;AfterClass</code>
