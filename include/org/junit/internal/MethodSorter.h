...
@property (readonly, class, strong) id<JavaUtilComparator> DEFAULT NS_SWIFT_NAME(DEFAULT);
@property (readonly, class, strong) id<JavaUtilComparator> NAME_ASCENDING NS_SWIFT_NAME(NAME_ASCENDING);
