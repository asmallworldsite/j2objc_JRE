 ...
 */
- (instancetype __nonnull)initWithNSString:(NSString *)assumption __attribute__((deprecated));
 ...
 */
- (instancetype __nonnull)initWithNSString:(NSString *)assumption
                     withJavaLangThrowable:(JavaLangThrowable *)e __attribute__((deprecated));
