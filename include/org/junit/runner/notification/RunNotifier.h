...
/*!
 ...
 <code>org.junit.AssumptionViolatedException</code>  thrown
 */
...
/*!
 @brief Invoke to tell listeners that an atomic test finished.Always invoke
  this method if you invoke <code>fireTestStarted(Description)</code>
...
/*!
 @brief Invoke to tell listeners that a test suite is about to finish.Always invoke
  this method if you invoke <code>fireTestSuiteStarted(Description)</code>
  as listeners are likely to expect them to come in pairs.
 @param description_ the description of the suite test (generally a class name)
 @since 4.13
 */
- (void)fireTestSuiteFinishedWithOrgJunitRunnerDescription:(OrgJunitRunnerDescription *)description_;

/*!
 @brief Invoke to tell listeners that a test suite is about to start.Runners are strongly
  encouraged--but not required--to call this method.
 If this method is called for
  a given <code>Description</code> then <code>fireTestSuiteFinished(Description)</code> MUST
  be called for the same <code>Description</code>.
 @param description_ the description of the suite test (generally a class name)
 @since 4.13
 */
...
/*!
 @brief Wraps the given listener with <code>SynchronizedRunListener</code> if
  it is not annotated with <code>RunListener.ThreadSafe</code>.
 */
