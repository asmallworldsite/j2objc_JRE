...
/*!
 @brief Gets the printed form of the exception and its stack trace.
 */
- (NSString *)getTrace;

/*!
 @brief Gets a the printed form of the exception, with a trimmed version of the stack trace.
