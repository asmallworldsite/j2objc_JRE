...
/*!
 @brief Returns the number of tests skipped because of an assumption failure
 @throw UnsupportedOperationExceptionif the result was serialized in a version before JUnit 4.13
 @since 4.13
 */
- (jint)getAssumptionFailureCount;

/*!
 @brief Returns the number of tests that failed during the run
 */
- (jint)getFailureCount;

/*!
 @brief Returns the <code>Failure</code>s describing tests that failed and the problems they encountered
 */
...
/*!
 @brief Returns the number of milliseconds it took to run the entire suite to run
 */
- (jlong)getRunTime;
