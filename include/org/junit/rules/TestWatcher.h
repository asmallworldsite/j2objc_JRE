...
@endcode
  <p>It is recommended to always set the <code>order</code> of the 
 <code>TestWatcher</code> to <code>Integer.MIN_VALUE</code> so that it encloses all
  other rules. Otherwise it may see failed tests as successful and vice versa
  if some rule changes the result of a test (e.g. <code>ErrorCollector</code> or 
...
- (void)skippedWithOrgJunitInternalAssumptionViolatedException:(OrgJunitInternalAssumptionViolatedException *)e
                                 withOrgJunitRunnerDescription:(OrgJunitRunnerDescription *)description_ __attribute__((deprecated));
