...
/*!
 @brief Asserts that two boolean arrays are equal.If they are not, an 
...
/*!
 @brief Asserts that two doubles are <b>not</b> equal to within a positive delta.
 If they are, an <code>AssertionError</code> is thrown. If the unexpected
  value is infinity then the delta value is ignored.NaNs are considered
...
/*!
 @brief Asserts that two floats are <b>not</b> equal to within a positive delta.
 If they are, an <code>AssertionError</code> is thrown. If the unexpected
  value is infinity then the delta value is ignored.NaNs are considered
...
+ (void)assertThatWithNSString:(NSString *)reason
                        withId:(id)actual
        withOrgHamcrestMatcher:(id<OrgHamcrestMatcher>)matcher __attribute__((deprecated));
...
/*!
 @brief Asserts that <code>runnable</code> throws an exception of type <code>expectedThrowable</code> when
  executed.If it does, the exception object is returned.
 If it does not throw an exception, an 
 <code>AssertionError</code> is thrown. If it throws the wrong type of exception, an <code>AssertionError</code>
  is thrown describing the mismatch; the exception that was actually thrown can
  be obtained by calling <code>AssertionError.getCause</code>.
 @param expectedThrowable the expected type of the exception
 @param runnable a function that is expected to throw an exception when executed
 @return the exception thrown by <code>runnable</code>
 @since 4.13
 */
+ (JavaLangThrowable *)assertThrowsWithIOSClass:(IOSClass *)expectedThrowable
...
/*!
 ...
 @since 4.13
 */
+ (JavaLangThrowable *)assertThrowsWithNSString:(NSString *)message
                                   withIOSClass:(IOSClass *)expectedThrowable
           withOrgJunitFunctionThrowingRunnable:(id<OrgJunitFunctionThrowingRunnable>)runnable;
...
FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithNSString_withId_withId_(NSString *message, id unexpected, id actual);

FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithId_withId_(id unexpected, id actual);

FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithNSString_withLong_withLong_(NSString *message, jlong unexpected, jlong actual);

FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithLong_withLong_(jlong unexpected, jlong actual);

FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithNSString_withDouble_withDouble_withDouble_(NSString *message, jdouble unexpected, jdouble actual, jdouble delta);

FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithDouble_withDouble_withDouble_(jdouble unexpected, jdouble actual, jdouble delta);

FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithFloat_withFloat_withFloat_(jfloat unexpected, jfloat actual, jfloat delta);
...
FOUNDATION_EXPORT void OrgJunitAssert_assertArrayEqualsWithNSString_withBooleanArray_withBooleanArray_(NSString *message, IOSBooleanArray *expecteds, IOSBooleanArray *actuals);

FOUNDATION_EXPORT void OrgJunitAssert_assertArrayEqualsWithBooleanArray_withBooleanArray_(IOSBooleanArray *expecteds, IOSBooleanArray *actuals);
...
FOUNDATION_EXPORT void OrgJunitAssert_assertNotEqualsWithNSString_withFloat_withFloat_withFloat_(NSString *message, jfloat unexpected, jfloat actual, jfloat delta);
...
FOUNDATION_EXPORT JavaLangThrowable *OrgJunitAssert_assertThrowsWithIOSClass_withOrgJunitFunctionThrowingRunnable_(IOSClass *expectedThrowable, id<OrgJunitFunctionThrowingRunnable> runnable);

FOUNDATION_EXPORT JavaLangThrowable *OrgJunitAssert_assertThrowsWithNSString_withIOSClass_withOrgJunitFunctionThrowingRunnable_(NSString *message, IOSClass *expectedThrowable, id<OrgJunitFunctionThrowingRunnable> runnable);
