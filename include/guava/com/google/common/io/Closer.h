...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/io/Closer.java
//
...
@property (readonly, class, strong) JavaLangReflectMethod *addSuppressed NS_SWIFT_NAME(addSuppressed);
