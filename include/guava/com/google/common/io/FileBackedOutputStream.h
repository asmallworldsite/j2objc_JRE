...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/io/FileBackedOutputStream.java
//
...
/*!
 ...
 <ul>
    <li><code>reset</code> is called (removing the data in this stream and deleting the file), or...
    <li>this stream (or, more precisely, its <code>asByteSource</code> view) is finalized during
        garbage collection, <strong>AND</strong> this stream was not constructed with the 1-arg constructor
  or the 2-arg constructor
  passing <code>false</code> in the
        second parameter. 
 </ul>
