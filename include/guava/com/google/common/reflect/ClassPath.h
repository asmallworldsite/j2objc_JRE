...
- (instancetype __nonnull)initWithJavaIoFile:(JavaIoFile * __nonnull)file
                                withNSString:(NSString * __nonnull)resourceName
                     withJavaLangClassLoader:(JavaLangClassLoader * __nonnull)loader;

/*!
 @brief Returns the file that includes this resource.
 */
- (JavaIoFile *)getFile;

+ (ComGoogleCommonReflectClassPath_ResourceInfo *)ofWithJavaIoFile:(JavaIoFile * __nonnull)file
                                                      withNSString:(NSString * __nonnull)resourceName
                                           withJavaLangClassLoader:(JavaLangClassLoader * __nonnull)loader;
...
@class ComGoogleCommonCollectImmutableSet;
@class ComGoogleCommonReflectClassPath_ResourceInfo;
@class JavaIoFile;
@class JavaLangClassLoader;
@class JavaNetURL;
...
- (void)scanFromWithJavaIoFile:(JavaIoFile * __nonnull)file
       withJavaLangClassLoader:(JavaLangClassLoader * __nonnull)classloader;

/*!
 @brief Called each time a resource (uniqueness not guaranteed if the class path includes redundant
  entries)
 */
- (void)scanResourceWithComGoogleCommonReflectClassPath_ResourceInfo:(ComGoogleCommonReflectClassPath_ResourceInfo * __nonnull)resource;
