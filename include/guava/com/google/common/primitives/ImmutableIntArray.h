...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/primitives/ImmutableIntArray.java
//
...
/*!
 ...
 <li>Can be streamed without "breaking the chain": <code>foo.getBarInts().stream()...</code>.
 ...
 <ul>
    ...
    <li>Access to <code>IntStream</code> features (like <code>IntStream.sum</code>) using <code>stream()</code>
        instead of the awkward <code>stream().mapToInt(v -> v)</code>.
  </ul>
 ...
 */
+ (ComGoogleCommonPrimitivesImmutableIntArray *)copyOfWithJavaUtilStreamIntStream:(id<JavaUtilStreamIntStream> __nonnull)stream OBJC_METHOD_FAMILY_NONE;
 ...
 */
- (void)forEachWithJavaUtilFunctionIntConsumer:(id<JavaUtilFunctionIntConsumer> __nonnull)consumer;
...
/*!
 @brief Appends all values from <code>stream</code>, in order, to the end of the values the built <code>ImmutableIntArray</code>
  will contain.
 */
- (ComGoogleCommonPrimitivesImmutableIntArray_Builder *)addAllWithJavaUtilStreamIntStream:(id<JavaUtilStreamIntStream> __nonnull)stream;
