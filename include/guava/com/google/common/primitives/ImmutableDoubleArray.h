...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/primitives/ImmutableDoubleArray.java
//
 ...
 */
+ (ComGoogleCommonPrimitivesImmutableDoubleArray *)copyOfWithJavaUtilStreamDoubleStream:(id<JavaUtilStreamDoubleStream> __nonnull)stream OBJC_METHOD_FAMILY_NONE;
 ...
 */
- (void)forEachWithJavaUtilFunctionDoubleConsumer:(id<JavaUtilFunctionDoubleConsumer> __nonnull)consumer;
...
/*!
 @brief Appends all values from <code>stream</code>, in order, to the end of the values the built <code>ImmutableDoubleArray</code>
  will contain.
 */
- (ComGoogleCommonPrimitivesImmutableDoubleArray_Builder *)addAllWithJavaUtilStreamDoubleStream:(id<JavaUtilStreamDoubleStream> __nonnull)stream;
