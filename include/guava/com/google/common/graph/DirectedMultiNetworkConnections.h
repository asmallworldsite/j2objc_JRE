...
+ (ComGoogleCommonGraphDirectedMultiNetworkConnections *)ofImmutableWithJavaUtilMap:(id<JavaUtilMap> __nonnull)inEdges
                                                                    withJavaUtilMap:(id<JavaUtilMap> __nonnull)outEdges
