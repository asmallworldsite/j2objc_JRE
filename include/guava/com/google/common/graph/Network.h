...
/*!
 ...
 <code>node</code>.
 <p>This is equal to the union of <code>inEdges(Object)</code> and <code>outEdges(Object)</code>.
 @throw IllegalArgumentExceptionif <code>node</code> is not an element of this network
 */
...
/*!
 @brief Returns the set of edges that each directly connect <code>nodeU</code> to <code>nodeV</code>.
...
/*!
 @brief Returns the set of edges that each directly connect <code>endpoints</code> (in the order, if any,
  specified by <code>endpoints</code>).
 <p>The resulting set of edges will be parallel (i.e. have equal <code>incidentNodes(Object)</code>.
  If this network does not <code>allow parallel edges</code>, the resulting set
  will contain at most one edge (equivalent to <code>edgeConnecting(endpoints).asSet()</code>).
  
 <p>If this network is directed, <code>endpoints</code> must be ordered.
 @throw IllegalArgumentExceptionif either endpoint is not an element of this network
...
/*!
 @brief Returns the single edge that directly connects <code>nodeU</code> to <code>nodeV</code>, if one is
  present, or <code>Optional.empty()</code> if no such edge exists.
...
/*!
 @brief Returns the single edge that directly connects <code>endpoints</code> (in the order, if any,
  specified by <code>endpoints</code>), if one is present, or <code>Optional.empty()</code> if no such edge
  exists.
...
/*!
 @brief Returns the single edge that directly connects <code>nodeU</code> to <code>nodeV</code>, if one is
  present, or <code>null</code> if no such edge exists.
...
/*!
 @brief Returns the single edge that directly connects <code>endpoints</code> (in the order, if any,
  specified by <code>endpoints</code>), if one is present, or <code>null</code> if no such edge exists.
 <p>If this graph is directed, the endpoints must be ordered.
 @throw IllegalArgumentExceptionif there are multiple parallel edges connecting <code>nodeU</code>
      to <code>nodeV</code>
 @throw IllegalArgumentExceptionif either endpoint is not an element of this network
...
/*!
 @brief Returns true if there is an edge that directly connects <code>endpoints</code> (in the order, if
  any, specified by <code>endpoints</code>).
 <p>Unlike the other <code>EndpointPair</code>-accepting methods, this method does not throw if the
  ...
  consistency with <code>Graph.hasEdgeConnecting(EndpointPair)</code> and <code>ValueGraph.hasEdgeConnecting(EndpointPair)</code>
 .
 @since 27.1
 */
