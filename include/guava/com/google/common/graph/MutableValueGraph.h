...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/graph/MutableValueGraph.java
//
...
/*!
 @brief Adds an edge connecting <code>nodeU</code> to <code>nodeV</code> if one is not already present, and sets
  a value for that edge to <code>value</code> (overwriting the existing value, if any).
...
/*!
 ...
 <p>If this graph is directed, <code>endpoints</code> must be ordered.
 @return the value previously associated with the edge connecting <code>endpoints</code>, or null if
