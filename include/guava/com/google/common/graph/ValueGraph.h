...
/*!
 @brief Returns the value of the edge that connects <code>nodeU</code> to <code>nodeV</code> (in the order, if
  any, specified by <code>endpoints</code>), if one is present; otherwise, returns <code>Optional.empty()</code>
 .
 ...
 */
- (JavaUtilOptional *)edgeValueWithId:(id __nonnull)nodeU
                               withId:(id __nonnull)nodeV;

/*!
 @brief Returns the value of the edge that connects <code>endpoints</code> (in the order, if any, specified
  by <code>endpoints</code>), if one is present; otherwise, returns <code>Optional.empty()</code>.
 <p>If this graph is directed, the endpoints must be ordered.
 @throw IllegalArgumentExceptionif either endpoint is not an element of this graph
 @throw IllegalArgumentExceptionif the endpoints are unordered and the graph is directed
 @since 27.1
 */
- (JavaUtilOptional *)edgeValueWithComGoogleCommonGraphEndpointPair:(ComGoogleCommonGraphEndpointPair * __nonnull)endpoints;

/*!
 @brief Returns the value of the edge that connects <code>nodeU</code> to <code>nodeV</code>, if one is present;
...
/*!
 @brief Returns the value of the edge that connects <code>endpoints</code> (in the order, if any, specified
  by <code>endpoints</code>), if one is present; otherwise, returns <code>defaultValue</code>.
 <p>If this graph is directed, the endpoints must be ordered.
 @throw IllegalArgumentExceptionif either endpoint is not an element of this graph
 @throw IllegalArgumentExceptionif the endpoints are unordered and the graph is directed
 @since 27.1
