...
/*!
 ...
 <p>Anything after a <code>%</code> in an IPv6 address is ignored (assumed to be a Scope ID).
...
/*!
 @brief Returns the <code>Inet4Address</code> corresponding to a given <code>BigInteger</code>.
 @param address BigInteger representing the IPv4 address
 @return Inet4Address representation of the given BigInteger
 @throw IllegalArgumentExceptionif the BigInteger is not between 0 and 2^32-1
 @since 28.2
 */
+ (JavaNetInet4Address *)fromIPv4BigIntegerWithJavaMathBigInteger:(JavaMathBigInteger * __nonnull)address;

/*!
 @brief Returns the <code>Inet6Address</code> corresponding to a given <code>BigInteger</code>.
 @param address BigInteger representing the IPv6 address
 @return Inet6Address representation of the given BigInteger
 @throw IllegalArgumentExceptionif the BigInteger is not between 0 and 2^128-1
 @since 28.2
 */
+ (JavaNetInet6Address *)fromIPv6BigIntegerWithJavaMathBigInteger:(JavaMathBigInteger * __nonnull)address;
...
/*!
 ...
 <p>HACK: As long as applications continue to use IPv4 addresses for indexing into tables,
  ...
  This function does so by hashing 64 bits of the IPv6 address into <code>224.0.0.0/3</code> (64 bits
  into 29 bits): 
 <ul>
...
/*!
 @brief Returns a BigInteger representing the address.
 <p>Unlike <code>coerceToInteger</code>, IPv6 addresses are not coerced to IPv4 addresses.
 @param address<code>InetAddress</code>  to convert
 @return <code>BigInteger</code> representation of the address
 @since 28.2
 */
+ (JavaMathBigInteger *)toBigIntegerWithJavaNetInetAddress:(JavaNetInetAddress * __nonnull)address;
...
FOUNDATION_EXPORT JavaMathBigInteger *ComGoogleCommonNetInetAddresses_toBigIntegerWithJavaNetInetAddress_(JavaNetInetAddress *address);

FOUNDATION_EXPORT JavaNetInet4Address *ComGoogleCommonNetInetAddresses_fromIntegerWithInt_(jint address);

FOUNDATION_EXPORT JavaNetInet4Address *ComGoogleCommonNetInetAddresses_fromIPv4BigIntegerWithJavaMathBigInteger_(JavaMathBigInteger *address);

FOUNDATION_EXPORT JavaNetInet6Address *ComGoogleCommonNetInetAddresses_fromIPv6BigIntegerWithJavaMathBigInteger_(JavaMathBigInteger *address);
