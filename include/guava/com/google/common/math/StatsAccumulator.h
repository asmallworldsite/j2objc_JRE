...
/*!
 @brief Adds the given values to the dataset.The stream will be completely consumed by this method.
 @param values a series of values
 @since 28.2
 */
- (void)addAllWithJavaUtilStreamDoubleStream:(id<JavaUtilStreamDoubleStream> __nonnull)values;
...
/*!
 ...
 @since 28.2
 */
- (void)addAllWithJavaUtilStreamIntStream:(id<JavaUtilStreamIntStream> __nonnull)values;
...
/*!
 ...
 @since 28.2
 */
- (void)addAllWithJavaUtilStreamLongStream:(id<JavaUtilStreamLongStream> __nonnull)values;
...
/*!
 ...
 @since 28.2
 */
- (void)addAllWithComGoogleCommonMathStatsAccumulator:(ComGoogleCommonMathStatsAccumulator * __nonnull)values;
