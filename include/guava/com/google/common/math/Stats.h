...
/*!
 @brief Returns statistics over a dataset containing the given values.The stream will be completely
  consumed by this method.
 <p>If you have a <code>Stream<Double></code> rather than a <code>DoubleStream</code>, you should collect
  the values using <code>toStats()</code> instead.
 @param values a series of values
 @since 28.2
 */
+ (ComGoogleCommonMathStats *)ofWithJavaUtilStreamDoubleStream:(id<JavaUtilStreamDoubleStream> __nonnull)values;
...
/*!
 @brief Returns statistics over a dataset containing the given values.The stream will be completely
  consumed by this method.
 <p>If you have a <code>Stream<Integer></code> rather than an <code>IntStream</code>, you should collect
  the values using <code>toStats()</code> instead.
 @param values a series of values
 @since 28.2
 */
+ (ComGoogleCommonMathStats *)ofWithJavaUtilStreamIntStream:(id<JavaUtilStreamIntStream> __nonnull)values;
...
/*!
 @brief Returns statistics over a dataset containing the given values.The stream will be completely
  consumed by this method.
 <p>If you have a <code>Stream<Long></code> rather than a <code>LongStream</code>, you should collect the
  values using <code>toStats()</code> instead.
 @param values a series of values, which will be converted to <code>double</code>  values (this may
       cause loss of precision for longs of magnitude over 2^53 (slightly over 9e15))
 @since 28.2
 */
+ (ComGoogleCommonMathStats *)ofWithJavaUtilStreamLongStream:(id<JavaUtilStreamLongStream> __nonnull)values;
...
/*!
 @brief Returns a <code>Collector</code> which accumulates statistics from a <code>java.util.stream.Stream</code>
  of any type of boxed <code>Number</code> into a <code>Stats</code>.Use by calling <code>boxedNumericStream.collect(toStats())</code>
 .
 The numbers will be converted to <code>double</code> values
  (which may cause loss of precision). 
 <p>If you have any of the primitive streams <code>DoubleStream</code>, <code>IntStream</code>, or <code>LongStream</code>
 , you should use the factory method <code>of</code> instead.
 @since 28.2
 */
+ (id<JavaUtilStreamCollector>)toStats;
...
FOUNDATION_EXPORT ComGoogleCommonMathStats *ComGoogleCommonMathStats_ofWithJavaUtilStreamDoubleStream_(id<JavaUtilStreamDoubleStream> values);

FOUNDATION_EXPORT ComGoogleCommonMathStats *ComGoogleCommonMathStats_ofWithJavaUtilStreamIntStream_(id<JavaUtilStreamIntStream> values);

FOUNDATION_EXPORT ComGoogleCommonMathStats *ComGoogleCommonMathStats_ofWithJavaUtilStreamLongStream_(id<JavaUtilStreamLongStream> values);

FOUNDATION_EXPORT id<JavaUtilStreamCollector> ComGoogleCommonMathStats_toStats(void);
