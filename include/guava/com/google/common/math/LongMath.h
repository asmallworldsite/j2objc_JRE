...
/*!
 ...
 @since 30.0
 */
+ (jdouble)roundToDoubleWithLong:(jlong)x
        withJavaMathRoundingMode:(JavaMathRoundingMode * __nonnull)mode;
...
FOUNDATION_EXPORT jdouble ComGoogleCommonMathLongMath_roundToDoubleWithLong_withJavaMathRoundingMode_(jlong x, JavaMathRoundingMode *mode);
