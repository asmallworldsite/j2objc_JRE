...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/base/Optional.java
//
...
/*!
 @brief Returns the equivalent <code>com.google.common.base.Optional</code> value to the given <code>java.util.Optional</code>
 , or <code>null</code> if the argument is null.
 @since 21.0
 */
+ (ComGoogleCommonBaseOptional * __nullable)fromJavaUtilWithJavaUtilOptional:(JavaUtilOptional * __nullable)javaUtilOptional;
...
/*!
 @brief Returns the equivalent <code>java.util.Optional</code> value to this optional.
...
/*!
 @brief Returns the equivalent <code>java.util.Optional</code> value to the given <code>com.google.common.base.Optional</code>
 , or <code>null</code> if the argument is null.
 ...
 @since 21.0
 */
+ (JavaUtilOptional *)toJavaUtilWithComGoogleCommonBaseOptional:(ComGoogleCommonBaseOptional * __nullable)googleOptional;
