...
/*!
 ...
 Java 8 users may prefer <code>splitToStream</code> instead.
...
/*!
 @brief Splits <code>sequence</code> into string components and makes them available through an <code>Stream</code>
 , which may be lazily evaluated.If you want an eagerly computed <code>List</code>, use 
 <code>splitToList(CharSequence)</code>.
 @param sequence the sequence of characters to split
 ...
 @since 28.2
 */
- (id<JavaUtilStreamStream>)splitToStreamWithJavaLangCharSequence:(id<JavaLangCharSequence> __nonnull)sequence;
