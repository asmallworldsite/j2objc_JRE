...
/*!
 */
- (id)applyWithId:(id __nullable)a __attribute__((deprecated));
 ...
 */
- (id)convertWithId:(id __nullable)a;
...
- (id)correctedDoBackwardWithId:(id __nullable)b;

- (id)correctedDoForwardWithId:(id __nullable)a;
