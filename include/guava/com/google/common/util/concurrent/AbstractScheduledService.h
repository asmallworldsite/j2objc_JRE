...
/*!
 ...
 @since 28.0
 */
+ (ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *)newFixedDelayScheduleWithJavaTimeDuration:(JavaTimeDuration * __nonnull)initialDelay
                                                                                          withJavaTimeDuration:(JavaTimeDuration * __nonnull)delay OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @since 28.0
 */
+ (ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *)newFixedRateScheduleWithJavaTimeDuration:(JavaTimeDuration * __nonnull)initialDelay
                                                                                         withJavaTimeDuration:(JavaTimeDuration * __nonnull)period OBJC_METHOD_FAMILY_NONE;
...
FOUNDATION_EXPORT ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_newFixedDelayScheduleWithJavaTimeDuration_withJavaTimeDuration_(JavaTimeDuration *initialDelay, JavaTimeDuration *delay);
...
FOUNDATION_EXPORT ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_newFixedRateScheduleWithJavaTimeDuration_withJavaTimeDuration_(JavaTimeDuration *initialDelay, JavaTimeDuration *period);
