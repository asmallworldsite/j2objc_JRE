...
/*!
 ...
 @since 28.0
 */
- (jboolean)enterWithJavaTimeDuration:(JavaTimeDuration * __nonnull)time;
...
/*!
 ...
 @since 28.0
 */
- (jboolean)enterInterruptiblyWithJavaTimeDuration:(JavaTimeDuration * __nonnull)time;
...
/*!
 @brief Creates a new guard for this monitor.
 @param isSatisfied the new guard's boolean condition (see <code>isSatisfied()</code>
  )
 @since 21.0
 */
...
@interface ComGoogleCommonUtilConcurrentMonitor_Guard : NSObject {
 @public
  WEAK_ ComGoogleCommonUtilConcurrentMonitor *monitor_;
