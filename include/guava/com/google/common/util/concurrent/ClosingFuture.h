...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/util/concurrent/ClosingFuture.java
//
 ...
 */
- (id<JavaLangAutoCloseable>)eventuallyCloseWithId:(id<JavaLangAutoCloseable> __nonnull)closeable
 ...
 */
- (id)callWithComGoogleCommonUtilConcurrentClosingFuture_DeferredCloser:(ComGoogleCommonUtilConcurrentClosingFuture_DeferredCloser * __nonnull)closer;
...
/*!
 ...
 <p>Any objects that are passed to <code>closer.eventuallyClose()</code>
  ...
  not before this method completes), even if this method throws or the pipeline is cancelled.
 */
- (id)applyWithComGoogleCommonUtilConcurrentClosingFuture_DeferredCloser:(ComGoogleCommonUtilConcurrentClosingFuture_DeferredCloser * __nonnull)closer
                                                                  withId:(id __nonnull)input;
 ...
 */
- (id)getDoneWithComGoogleCommonUtilConcurrentClosingFuture:(ComGoogleCommonUtilConcurrentClosingFuture * __nonnull)closingFuture;
 ...
 */
- (id)applyWithComGoogleCommonUtilConcurrentClosingFuture_DeferredCloser:(ComGoogleCommonUtilConcurrentClosingFuture_DeferredCloser * __nonnull)closer
                                                                  withId:(id __nonnull)value1
                                                                  withId:(id __nonnull)value2;
