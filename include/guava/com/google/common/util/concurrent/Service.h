...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/util/concurrent/Service.java
//
...
FOUNDATION_EXPORT void ComGoogleCommonUtilConcurrentService_awaitRunningWithJavaTimeDuration_(id<ComGoogleCommonUtilConcurrentService> self, JavaTimeDuration *timeout);

FOUNDATION_EXPORT void ComGoogleCommonUtilConcurrentService_awaitTerminatedWithJavaTimeDuration_(id<ComGoogleCommonUtilConcurrentService> self, JavaTimeDuration *timeout);
