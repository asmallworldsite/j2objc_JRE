...
/*!
 ...
 @since 28.0
 */
+ (ComGoogleCommonUtilConcurrentFluentFuture *)fromWithComGoogleCommonUtilConcurrentFluentFuture:(ComGoogleCommonUtilConcurrentFluentFuture * __nonnull)future __attribute__((deprecated));
...
/*!
 ...
 @since 28.0
 */
- (ComGoogleCommonUtilConcurrentFluentFuture *)withTimeoutWithJavaTimeDuration:(JavaTimeDuration * __nonnull)timeout
