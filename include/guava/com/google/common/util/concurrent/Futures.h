...
/*!
 ...
 <p>Exceptions thrown by a <code>callback</code> will be propagated up to the executor. Any exception
  thrown during <code>Executor.execute</code> (e.g., a <code>RejectedExecutionException</code> or an
...
@endcode
 ...
 <p>When selecting an executor, note that <code>directExecutor</code> is dangerous in some cases. See
  the warnings the <code>MoreExecutors.directExecutor</code> documentation. 
...
/*!
 ...
 <p>This differs from <code>successfulAsList(Iterable)</code> in that it will return a failed future
...
/*!
 @brief Creates a new <code>ListenableFuture</code> whose value is a list containing the values of all its
  input futures, if all succeed.
 <p>The list of results is in the same order as the input list. 
 <p>This differs from <code>successfulAsList(ListenableFuture[])</code> in that it will return a
...
/*!
 @brief Returns a successful <code>ListenableFuture<Void></code>.This method is equivalent to <code>immediateFuture(null)</code>
  except that it is restricted to produce futures of type <code>Void</code>.
 @since 29.0
 */
...
/*!
 @brief Executes <code>runnable</code> on the specified <code>executor</code>, returning a <code>Future</code> that
  will complete after execution.
 @throw RejectedExecutionExceptionif the task cannot be scheduled for execution
 @since 28.2
 */
+ (id<ComGoogleCommonUtilConcurrentListenableFuture>)submitWithJavaLangRunnable:(id<JavaLangRunnable> __nonnull)runnable
                                                 withJavaUtilConcurrentExecutor:(id<JavaUtilConcurrentExecutor> __nonnull)executor;
...
/*!
 ...
 <p>The list of results is in the same order as the input list. 
 <p>This differs from <code>allAsList(Iterable)</code> in that it's tolerant of failed futures for
  any of the items, representing them as <code>null</code> in the result list. 
...
/*!
 ...
 <p>The list of results is in the same order as the input list. 
 <p>This differs from <code>allAsList(ListenableFuture[])</code> in that it's tolerant of failed
  futures for any of the items, representing them as <code>null</code> in the result list. 
 <p>Canceling this future will attempt to cancel all the component futures.
 @param futures futures to combine
 @return a future that provides a list of the results of the component futures
 @since 10.0
...
+ (id<ComGoogleCommonUtilConcurrentListenableFuture>)withTimeoutWithComGoogleCommonUtilConcurrentListenableFuture:(id<ComGoogleCommonUtilConcurrentListenableFuture> __nonnull)delegate
                                                                                             withJavaTimeDuration:(JavaTimeDuration * __nonnull)time
