...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/cache/CacheBuilder.java
//
...
/*!
 ...
 <ul>
    ...
    <li>keys automatically wrapped in <code>WeakReference</code>
    <li>values automatically wrapped in <code>WeakReference</code> or <code>SoftReference</code>
...
/*!
 @brief Specifies that each entry should be automatically removed from the cache once a fixed duration
  ...
  and <code>Cache.asMap().put(K, V)</code>), but not by <code>containsKey(Object)</code>
 , nor by operations on the collection-views of <code>Cache.asMap</code>.
 So, for
