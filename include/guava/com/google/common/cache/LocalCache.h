...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/cache/LocalCache.java
//
...
- (id)getIfPresentWithId:(id __nonnull)key;
...
- (jboolean)removeIfWithJavaUtilFunctionBiPredicate:(id<JavaUtilFunctionBiPredicate> __nonnull)filter;
...
/*!
 ...
 <code>null</code> if another thread is performing the refresh or if an error occurs during
  refresh.
 */
- (id)refreshWithId:(id __nonnull)key
            withInt:(jint)hash_
withComGoogleCommonCacheCacheLoader:(ComGoogleCommonCacheCacheLoader * __nonnull)loader
        withBoolean:(jboolean)checkTime;
