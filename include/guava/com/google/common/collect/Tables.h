...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/collect/Tables.java
//
...
/*!
 @brief Returns a <code>Collector</code> that accumulates elements into a <code>Table</code> created using the
  specified supplier, whose cells are generated by applying the provided mapping functions to the
  input elements.Cells are inserted into the generated <code>Table</code> in encounter order.
 <p>If multiple input elements map to the same row and column, the specified merging function is
  used to combine the values. Like <code>java.util.stream.Collectors.toMap(java.util.function.Function, java.util.function.Function,
 BinaryOperator, java.util.function.Supplier)</code>
 , this Collector throws a <code>NullPointerException</code>
  on null values returned from <code>valueFunction</code>, and treats nulls
  returned from <code>mergeFunction</code> as removals of that row/column pair.
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)toTableWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)rowFunction
                                      withJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)columnFunction
                                ...
                                withJavaUtilFunctionBinaryOperator:(id<JavaUtilFunctionBinaryOperator> __nonnull)mergeFunction
                                      withJavaUtilFunctionSupplier:(id<JavaUtilFunctionSupplier> __nonnull)tableSupplier;

/*!
 @brief Returns a <code>Collector</code> that accumulates elements into a <code>Table</code> created using the
  specified supplier, whose cells are generated by applying the provided mapping functions to the
  input elements.Cells are inserted into the generated <code>Table</code> in encounter order.
 <p>If multiple input elements map to the same row and column, an <code>IllegalStateException</code>
