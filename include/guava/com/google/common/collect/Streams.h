 ...
 */
+ (id<JavaUtilStreamDoubleStream>)concatWithJavaUtilStreamDoubleStreamArray:(IOSObjectArray * __nonnull)streams;
 ...
 */
+ (id<JavaUtilStreamIntStream>)concatWithJavaUtilStreamIntStreamArray:(IOSObjectArray * __nonnull)streams;
 ...
 */
+ (id<JavaUtilStreamLongStream>)concatWithJavaUtilStreamLongStreamArray:(IOSObjectArray * __nonnull)streams;
 ...
 */
+ (id<JavaUtilStreamStream>)concatWithJavaUtilStreamStreamArray:(IOSObjectArray * __nonnull)streams;
 ...
 */
+ (JavaUtilOptionalDouble *)findLastWithJavaUtilStreamDoubleStream:(id<JavaUtilStreamDoubleStream> __nonnull)stream;
...
/*!
 ...
 @throw NullPointerExceptionif the last element of the stream is null
 */
+ (JavaUtilOptionalInt *)findLastWithJavaUtilStreamIntStream:(id<JavaUtilStreamIntStream> __nonnull)stream;
...
/*!
 ...
 @throw NullPointerExceptionif the last element of the stream is null
 */
+ (JavaUtilOptionalLong *)findLastWithJavaUtilStreamLongStream:(id<JavaUtilStreamLongStream> __nonnull)stream;
...
/*!
 ...
 @throw NullPointerExceptionif the last element of the stream is null
 */
+ (JavaUtilOptional *)findLastWithJavaUtilStreamStream:(id<JavaUtilStreamStream> __nonnull)stream;
...
@endcode
 ...
 @since 22.0
 */
+ (void)forEachPairWithJavaUtilStreamStream:(id<JavaUtilStreamStream> __nonnull)streamA
                   withJavaUtilStreamStream:(id<JavaUtilStreamStream> __nonnull)streamB
             withJavaUtilFunctionBiConsumer:(id<JavaUtilFunctionBiConsumer> __nonnull)consumer;
...
@endcode
 ...
 <p>The order of the resulting stream is defined if and only if the order of the original stream
  was defined.
 */
+ (id<JavaUtilStreamStream>)mapWithIndexWithJavaUtilStreamDoubleStream:(id<JavaUtilStreamDoubleStream> __nonnull)stream
             withComGoogleCommonCollectStreams_DoubleFunctionWithIndex:(id<ComGoogleCommonCollectStreams_DoubleFunctionWithIndex> __nonnull)function;
...
@endcode
 ...
 <p>The order of the resulting stream is defined if and only if the order of the original stream
  was defined.
 */
+ (id<JavaUtilStreamStream>)mapWithIndexWithJavaUtilStreamIntStream:(id<JavaUtilStreamIntStream> __nonnull)stream
             withComGoogleCommonCollectStreams_IntFunctionWithIndex:(id<ComGoogleCommonCollectStreams_IntFunctionWithIndex> __nonnull)function;
...
@endcode
 ...
 <p>The order of the resulting stream is defined if and only if the order of the original stream
  was defined.
 */
+ (id<JavaUtilStreamStream>)mapWithIndexWithJavaUtilStreamLongStream:(id<JavaUtilStreamLongStream> __nonnull)stream
             withComGoogleCommonCollectStreams_LongFunctionWithIndex:(id<ComGoogleCommonCollectStreams_LongFunctionWithIndex> __nonnull)function;
...
@endcode
 ...
 <p>The order of the resulting stream is defined if and only if the order of the original stream
  was defined.
 */
+ (id<JavaUtilStreamStream>)mapWithIndexWithJavaUtilStreamStream:(id<JavaUtilStreamStream> __nonnull)stream
             withComGoogleCommonCollectStreams_FunctionWithIndex:(id<ComGoogleCommonCollectStreams_FunctionWithIndex> __nonnull)function;

/*!
 @brief Returns <code>Collection.stream</code>.
 */
+ (id<JavaUtilStreamStream>)streamWithJavaUtilCollection:(id<JavaUtilCollection> __nonnull)collection __attribute__((deprecated));
...
/*!
 @brief Returns a sequential <code>Stream</code> of the contents of <code>iterable</code>, delegating to <code>Collection.stream</code>
  if possible.
 */
+ (id<JavaUtilStreamStream>)streamWithJavaLangIterable:(id<JavaLangIterable> __nonnull)iterable;
 ...
 */
+ (id<JavaUtilStreamStream>)streamWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)iterator;

/*!
 @brief If a value is present in <code>optional</code>, returns a stream containing only that element,
  otherwise returns an empty stream.
 */
+ (id<JavaUtilStreamStream>)streamWithComGoogleCommonBaseOptional:(ComGoogleCommonBaseOptional * __nonnull)optional;
 ...
 */
+ (id<JavaUtilStreamStream>)streamWithJavaUtilOptional:(JavaUtilOptional * __nonnull)optional;
...
/*!
 ...
 <p><b>Java 9 users:</b> use <code>optional.stream()</code> instead.
 */
+ (id<JavaUtilStreamDoubleStream>)streamWithJavaUtilOptionalDouble:(JavaUtilOptionalDouble * __nonnull)optional;
...
/*!
 ...
 <p><b>Java 9 users:</b> use <code>optional.stream()</code> instead.
 */
+ (id<JavaUtilStreamIntStream>)streamWithJavaUtilOptionalInt:(JavaUtilOptionalInt * __nonnull)optional;
...
/*!
 ...
 <p><b>Java 9 users:</b> use <code>optional.stream()</code> instead.
 */
+ (id<JavaUtilStreamLongStream>)streamWithJavaUtilOptionalLong:(JavaUtilOptionalLong * __nonnull)optional;

/*!
 @brief Returns a stream in which each element is the result of passing the corresponding element of
 ...
 */
+ (id<JavaUtilStreamStream>)zipWithJavaUtilStreamStream:(id<JavaUtilStreamStream> __nonnull)streamA
                               withJavaUtilStreamStream:(id<JavaUtilStreamStream> __nonnull)streamB
                         withJavaUtilFunctionBiFunction:(id<JavaUtilFunctionBiFunction> __nonnull)function;
 ...
 */
- (id)applyWithId:(id __nonnull)from
