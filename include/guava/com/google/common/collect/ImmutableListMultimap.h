...
@endcode
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)flatteningToImmutableListMultimapWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)keyFunction
                                                                withJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)valuesFunction;
...
/*!
 @brief Returns a <code>Collector</code> that accumulates elements into an <code>ImmutableListMultimap</code>
  ...
  elements.
 <p>For streams with defined encounter order (as defined in the Ordering section of the <code>java.util.stream</code>
  Javadoc), that order is preserved, but entries are <a href="ImmutableMultimap.html#iteration">
 grouped by key</a>.
...
@endcode
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)toImmutableListMultimapWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)keyFunction
...
- (ComGoogleCommonCollectImmutableListMultimap_Builder *)combineWithComGoogleCommonCollectImmutableMultimap_Builder:(ComGoogleCommonCollectImmutableMultimap_Builder * __nonnull)other;
