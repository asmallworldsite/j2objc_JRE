...
- (jint)compareToWithId:(ComGoogleCommonCollectCut * __nonnull)that;
...
- (instancetype __nonnull)initPackagePrivateWithJavaLangComparable:(id<JavaLangComparable> __nullable)endpoint;

+ (ComGoogleCommonCollectCut *)aboveAll;

+ (ComGoogleCommonCollectCut *)aboveValueWithJavaLangComparable:(id<JavaLangComparable> __nonnull)endpoint;

+ (ComGoogleCommonCollectCut *)belowAll;

+ (ComGoogleCommonCollectCut *)belowValueWithJavaLangComparable:(id<JavaLangComparable> __nonnull)endpoint;

- (ComGoogleCommonCollectCut *)canonicalWithComGoogleCommonCollectDiscreteDomain:(ComGoogleCommonCollectDiscreteDomain * __nonnull)domain;

- (void)describeAsLowerBoundWithJavaLangStringBuilder:(JavaLangStringBuilder * __nonnull)sb;

- (void)describeAsUpperBoundWithJavaLangStringBuilder:(JavaLangStringBuilder * __nonnull)sb;

- (id<JavaLangComparable>)endpoint;

- (id<JavaLangComparable>)greatestValueBelowWithComGoogleCommonCollectDiscreteDomain:(ComGoogleCommonCollectDiscreteDomain * __nonnull)domain;

- (jboolean)isLessThanWithJavaLangComparable:(id<JavaLangComparable> __nonnull)value;

- (id<JavaLangComparable>)leastValueAboveWithComGoogleCommonCollectDiscreteDomain:(ComGoogleCommonCollectDiscreteDomain * __nonnull)domain;

- (ComGoogleCommonCollectBoundType *)typeAsLowerBound;

- (ComGoogleCommonCollectBoundType *)typeAsUpperBound;

- (ComGoogleCommonCollectCut *)withLowerBoundTypeWithComGoogleCommonCollectBoundType:(ComGoogleCommonCollectBoundType * __nonnull)boundType
                                            withComGoogleCommonCollectDiscreteDomain:(ComGoogleCommonCollectDiscreteDomain * __nonnull)domain;

- (ComGoogleCommonCollectCut *)withUpperBoundTypeWithComGoogleCommonCollectBoundType:(ComGoogleCommonCollectBoundType * __nonnull)boundType
                                            withComGoogleCommonCollectDiscreteDomain:(ComGoogleCommonCollectDiscreteDomain * __nonnull)domain;
