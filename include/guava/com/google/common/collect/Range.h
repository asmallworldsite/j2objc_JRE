...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/collect/Range.java
//
...
/*!
 ...
 @throw ClassCastExceptionif <code>lower</code> and <code>upper</code> are not mutually comparable
 @since 14.0
 */
...
/*!
 ...
 @throw ClassCastExceptionif the values are not mutually comparable
...
/*!
 @brief Returns the maximal range lying between this range and <code>otherRange</code>, if such a range
  exists.The resulting range may be empty if the two ranges are adjacent but non-overlapping.
 <p>For example, the gap of <code>[1..5]</code> and <code>(7..10)</code> is <code>(5..7]</code>. The resulting
  range may be empty; for example, the gap between <code>[1..5)</code> <code>[5..7)</code> yields the empty
  range <code>[5..5)</code>.
 ...
 @throw IllegalArgumentExceptionif this range and <code>otherRange</code> have a nonempty
      intersection
 @since 27.0
 */
- (ComGoogleCommonCollectRange *)gapWithComGoogleCommonCollectRange:(ComGoogleCommonCollectRange * __nonnull)otherRange;
