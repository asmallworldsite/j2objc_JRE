...
@endcode
 ...
 @throw IllegalArgumentExceptionif the cartesian product size exceeds the <code>int</code> range
 @since 2.0
 */
+ (id<JavaUtilSet>)cartesianProductWithJavaUtilList:(id<JavaUtilList> __nonnull)sets;
...
@endcode
 ...
 @since 2.0
 */
+ (id<JavaUtilSet>)cartesianProductWithJavaUtilSetArray:(IOSObjectArray * __nonnull)sets;
...
/*!
 ...
 @since 23.0
 */
+ (id<JavaUtilSet>)combinationsWithJavaUtilSet:(id<JavaUtilSet> __nonnull)set
                                       withInt:(jint)size;
 ...
 */
+ (JavaUtilEnumSet *)complementOfWithJavaUtilCollection:(id<JavaUtilCollection> __nonnull)collection;
...
/*!
 ...
 <p>Results are undefined if <code>set1</code> and <code>set2</code> are sets based on different
  ...
  all are).
 */
+ (ComGoogleCommonCollectSets_SetView *)differenceWithJavaUtilSet:(id<JavaUtilSet> __nonnull)set1
                                                  withJavaUtilSet:(id<JavaUtilSet> __nonnull)set2;
...
/*!
 ...
 @since 14.0
 */
+ (id<JavaUtilNavigableSet>)filterWithJavaUtilNavigableSet:(id<JavaUtilNavigableSet> __nonnull)unfiltered
 ...
 */
+ (id<JavaUtilSet>)filterWithJavaUtilSet:(id<JavaUtilSet> __nonnull)unfiltered
        withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;
...
/*!
 ...
 @since 11.0
 */
+ (id<JavaUtilSortedSet>)filterWithJavaUtilSortedSet:(id<JavaUtilSortedSet> __nonnull)unfiltered
                    withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;
 ...
 */
+ (ComGoogleCommonCollectImmutableSet *)immutableEnumSetWithJavaLangEnum:(JavaLangEnum * __nonnull)anElement
                                                   withJavaLangEnumArray:(IOSObjectArray * __nonnull)otherElements;
...
/*!
 ...
 @return an immutable set containing those elements, minus duplicates
 */
+ (ComGoogleCommonCollectImmutableSet *)immutableEnumSetWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements;
 ...
 */
+ (ComGoogleCommonCollectSets_SetView *)intersectionWithJavaUtilSet:(id<JavaUtilSet> __nonnull)set1
                                                    withJavaUtilSet:(id<JavaUtilSet> __nonnull)set2;
...
/*!
 ...
 @since 15.0
 */
+ (id<JavaUtilSet>)newConcurrentHashSetWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @since 12.0
 */
+ (JavaUtilConcurrentCopyOnWriteArraySet *)newCopyOnWriteArraySetWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
 ...
 */
+ (JavaUtilEnumSet *)newEnumSetWithJavaLangIterable:(id<JavaLangIterable> __nonnull)iterable
                                       withIOSClass:(IOSClass * __nonnull)elementType OBJC_METHOD_FAMILY_NONE;
 ...
 */
+ (JavaUtilHashSet *)newHashSetWithNSObjectArray:(IOSObjectArray * __nonnull)elements OBJC_METHOD_FAMILY_NONE;
 ...
 */
+ (JavaUtilHashSet *)newHashSetWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 <p>Overall, this method is not very useful and will likely be deprecated in the future.
 */
+ (JavaUtilHashSet *)newHashSetWithJavaUtilIterator:(id<JavaUtilIterator> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
 ...
 */
+ (JavaUtilLinkedHashSet *)newLinkedHashSetWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
 ...
 */
+ (id<JavaUtilSet>)newSetFromMapWithJavaUtilMap:(id<JavaUtilMap> __nonnull)map OBJC_METHOD_FAMILY_NONE __attribute__((deprecated));
 ...
 */
+ (JavaUtilTreeSet *)newTreeSetWithJavaUtilComparator:(id<JavaUtilComparator> __nonnull)comparator OBJC_METHOD_FAMILY_NONE;
 ...
 */
+ (JavaUtilTreeSet *)newTreeSetWithJavaLangIterable:(id<JavaLangIterable> __nonnull)elements OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @since 4.0
 */
+ (id<JavaUtilSet>)powerSetWithJavaUtilSet:(id<JavaUtilSet> __nonnull)set;
...
/*!
 ...
 @since 20.0
 */
+ (id<JavaUtilNavigableSet>)subSetWithJavaUtilNavigableSet:(id<JavaUtilNavigableSet> __nonnull)set
...
/*!
 ...
 @since 3.0
 */
+ (ComGoogleCommonCollectSets_SetView *)symmetricDifferenceWithJavaUtilSet:(id<JavaUtilSet> __nonnull)set1
                                                           withJavaUtilSet:(id<JavaUtilSet> __nonnull)set2;
...
@endcode
 ...
 @since 13.0
 */
+ (id<JavaUtilNavigableSet>)synchronizedNavigableSetWithJavaUtilNavigableSet:(id<JavaUtilNavigableSet> __nonnull)navigableSet;
 ...
 */
+ (ComGoogleCommonCollectSets_SetView *)union__WithJavaUtilSet:(id<JavaUtilSet> __nonnull)set1
                                               withJavaUtilSet:(id<JavaUtilSet> __nonnull)set2;
...
/*!
 ...
 @since 12.0
 */
+ (id<JavaUtilNavigableSet>)unmodifiableNavigableSetWithJavaUtilNavigableSet:(id<JavaUtilNavigableSet> __nonnull)set;
 ...
 */
+ (jboolean)equalsImplWithJavaUtilSet:(id<JavaUtilSet> __nonnull)s
                               withId:(id __nullable)object;

/*!
 @brief An implementation for <code>Set.hashCode()</code>.
 */
+ (jint)hashCodeImplWithJavaUtilSet:(id<JavaUtilSet> __nonnull)s;

+ (jboolean)removeAllImplWithJavaUtilSet:(id<JavaUtilSet> __nonnull)set
 ...
 */
- (id<JavaUtilSet>)copyIntoWithJavaUtilSet:(id<JavaUtilSet> __nonnull)set OBJC_METHOD_FAMILY_NONE;
...
/*!
 ...
 @throw UnsupportedOperationExceptionalways
 */
- (jboolean)removeIfWithJavaUtilFunctionPredicate:(id<JavaUtilFunctionPredicate> __nonnull)filter __attribute__((deprecated));
...
- (jboolean)removeIfWithJavaUtilFunctionPredicate:(id<JavaUtilFunctionPredicate> __nonnull)filter;
...
- (instancetype __nonnull)initWithJavaUtilNavigableSet:(id<JavaUtilNavigableSet> __nonnull)forward;
