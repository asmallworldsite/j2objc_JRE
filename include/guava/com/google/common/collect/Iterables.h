...
/*!
 ...
 @since 7.0
 */
+ (id)getFirstWithJavaLangIterable:(id<JavaLangIterable> __nonnull)iterable
                            withId:(id __nullable)defaultValue;
 ...
 */
+ (id)removeFirstMatchingWithJavaLangIterable:(id<JavaLangIterable> __nonnull)removeFrom
             withComGoogleCommonBasePredicate:(id<ComGoogleCommonBasePredicate> __nonnull)predicate;
