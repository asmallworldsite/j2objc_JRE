...
/*!
 @brief Returns <code>true</code> if this BiMap contains an entry whose value is equal to <code>value</code> (or,
  equivalently, if this inverse view contains a key that is equal to <code>value</code>).
...
- (id)outputWithComGoogleCommonCollectHashBiMap_BiEntry:(ComGoogleCommonCollectHashBiMap_BiEntry * __nonnull)entry_;
