...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/collect/Platform.java
//
...
/*!
 @brief Equivalent to Arrays.copyOfRange(source, from, to, arrayOfType.getClass()).
 */
+ (IOSObjectArray *)copy__WithNSObjectArray:(IOSObjectArray * __nonnull)source
                                    withInt:(jint)from
                                    withInt:(jint)to
                          withNSObjectArray:(IOSObjectArray * __nonnull)arrayOfType OBJC_METHOD_FAMILY_NONE;
...
J2OBJC_STATIC_INIT(ComGoogleCommonCollectPlatform)
