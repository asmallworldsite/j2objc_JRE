...
/*!
 ...
 @throw UnsupportedOperationExceptionalways
 */
- (void)replaceAllWithJavaUtilFunctionUnaryOperator:(id<JavaUtilFunctionUnaryOperator> __nonnull)operator_ __attribute__((deprecated));
...
/*!
 ...
 @throw UnsupportedOperationExceptionalways
 */
- (void)sortWithJavaUtilComparator:(id<JavaUtilComparator> __nonnull)c __attribute__((deprecated));
...
- (ComGoogleCommonCollectImmutableList_Builder *)combineWithComGoogleCommonCollectImmutableList_Builder:(ComGoogleCommonCollectImmutableList_Builder * __nonnull)builder;
