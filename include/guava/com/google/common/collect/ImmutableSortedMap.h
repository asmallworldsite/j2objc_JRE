...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/collect/ImmutableSortedMap.java
//
...
/*!
 @brief Returns a <code>Collector</code> that accumulates elements into an <code>ImmutableSortedMap</code> whose
  keys and values are the result of applying the provided mapping functions to the input
  elements.The generated map is sorted by the specified comparator.
 <p>If the mapped keys contain duplicates (according to the specified comparator), an <code>IllegalArgumentException</code>
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> ComGoogleCommonCollectImmutableSortedMap_toImmutableSortedMapWithJavaUtilComparator_withJavaUtilFunctionFunction_withJavaUtilFunctionFunction_(id<JavaUtilComparator> comparator, id<JavaUtilFunctionFunction> keyFunction, id<JavaUtilFunctionFunction> valueFunction);
...
- (ComGoogleCommonCollectImmutableSortedMap_Builder *)combineWithComGoogleCommonCollectImmutableMap_Builder:(ComGoogleCommonCollectImmutableMap_Builder * __nonnull)other;
