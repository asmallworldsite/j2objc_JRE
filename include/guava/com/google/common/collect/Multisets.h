...
/*!
 ...
 @since 22.0
 */
+ (id<JavaUtilStreamCollector>)toMultisetWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)elementFunction
                                    withJavaUtilFunctionToIntFunction:(id<JavaUtilFunctionToIntFunction> __nonnull)countFunction
                                         withJavaUtilFunctionSupplier:(id<JavaUtilFunctionSupplier> __nonnull)multisetSupplier;
...
+ (id<JavaUtilSpliterator>)spliteratorImplWithComGoogleCommonCollectMultiset:(id<ComGoogleCommonCollectMultiset> __nonnull)multiset;
