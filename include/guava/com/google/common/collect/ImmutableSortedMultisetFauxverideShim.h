...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/collect/ImmutableSortedMultisetFauxverideShim.java
//
...
/*!
 @brief Not supported.Use <code>ImmutableSortedMultiset.toImmutableSortedMultiset</code> instead.
 This
  method exists only to hide <code>ImmutableMultiset.toImmutableMultiset</code> from consumers of 
 <code>ImmutableSortedMultiset</code>.
 @throw UnsupportedOperationExceptionalways
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)toImmutableMultiset __attribute__((deprecated));
...
/*!
 ...
 @since 22.0
 */
+ (id<JavaUtilStreamCollector>)toImmutableMultisetWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)elementFunction
                                             withJavaUtilFunctionToIntFunction:(id<JavaUtilFunctionToIntFunction> __nonnull)countFunction __attribute__((deprecated));
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> ComGoogleCommonCollectImmutableSortedMultisetFauxverideShim_toImmutableMultiset(void);

FOUNDATION_EXPORT id<JavaUtilStreamCollector> ComGoogleCommonCollectImmutableSortedMultisetFauxverideShim_toImmutableMultisetWithJavaUtilFunctionFunction_withJavaUtilFunctionToIntFunction_(id<JavaUtilFunctionFunction> elementFunction, id<JavaUtilFunctionToIntFunction> countFunction);
