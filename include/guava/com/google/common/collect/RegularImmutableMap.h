 ...
 */
+ (jint)checkNoConflictInKeyBucketWithId:(id __nonnull)key
...
+ (ComGoogleCommonCollectImmutableMap *)fromEntriesWithJavaUtilMap_EntryArray:(IOSObjectArray * __nonnull)entries;
...
+ (id)getWithId:(id __nullable)key
withComGoogleCommonCollectImmutableMapEntryArray:(IOSObjectArray * __nullable)keyTable
        withInt:(jint)mask;
 ...
 */
+ (ComGoogleCommonCollectImmutableMapEntry *)makeImmutableWithJavaUtilMap_Entry:(id<JavaUtilMap_Entry> __nonnull)entry_;
