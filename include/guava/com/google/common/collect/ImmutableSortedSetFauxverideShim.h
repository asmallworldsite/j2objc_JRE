...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/collect/ImmutableSortedSetFauxverideShim.java
//
...
/*!
 @brief Not supported.Use <code>ImmutableSortedSet.toImmutableSortedSet</code> instead.
 This method exists
  only to hide <code>ImmutableSet.toImmutableSet</code> from consumers of <code>ImmutableSortedSet</code>.
 @throw UnsupportedOperationExceptionalways
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)toImmutableSet __attribute__((deprecated));
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> ComGoogleCommonCollectImmutableSortedSetFauxverideShim_toImmutableSet(void);
