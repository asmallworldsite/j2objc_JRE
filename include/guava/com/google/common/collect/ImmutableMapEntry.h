...
- (instancetype __nonnull)initPackagePrivateWithComGoogleCommonCollectImmutableMapEntry:(ComGoogleCommonCollectImmutableMapEntry * __nonnull)contents;

- (instancetype __nonnull)initPackagePrivateWithId:(id __nonnull)key
...
- (instancetype __nonnull)initWithId:(id __nonnull)key
                              withId:(id __nonnull)value
withComGoogleCommonCollectImmutableMapEntry:(ComGoogleCommonCollectImmutableMapEntry * __nonnull)nextInKeyBucket;
...
- (instancetype __nonnull)initPackagePrivateWithComGoogleCommonCollectImmutableMapEntry:(ComGoogleCommonCollectImmutableMapEntry * __nonnull)arg0 NS_UNAVAILABLE;
...
- (instancetype __nonnull)initWithId:(id __nonnull)key
                              withId:(id __nonnull)value
withComGoogleCommonCollectImmutableMapEntry:(ComGoogleCommonCollectImmutableMapEntry * __nonnull)nextInKeyBucket
withComGoogleCommonCollectImmutableMapEntry:(ComGoogleCommonCollectImmutableMapEntry * __nonnull)nextInValueBucket;
...
withComGoogleCommonCollectImmutableMapEntry:(ComGoogleCommonCollectImmutableMapEntry * __nonnull)arg2 NS_UNAVAILABLE;
