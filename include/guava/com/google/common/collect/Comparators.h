...
/*!
 ...
 @since 22.0
 */
+ (id<JavaUtilComparator>)emptiesFirstWithJavaUtilComparator:(id<JavaUtilComparator> __nonnull)valueComparator;
...
/*!
 ...
 @since 22.0
 */
+ (id<JavaUtilComparator>)emptiesLastWithJavaUtilComparator:(id<JavaUtilComparator> __nonnull)valueComparator;
...
/*!
 @brief Returns the maximum of the two values.If the values compare as 0, the first is returned.
 <p>The recommended solution for finding the <code>maximum</code> of some values depends on the type
  of your data and the number of elements you have. Read more in the Guava User Guide article on 
 <a href="https://github.com/google/guava/wiki/CollectionUtilitiesExplained#comparators"><code>Comparators</code>
 </a>.
 ...
 @since 30.0
 */
+ (id<JavaLangComparable>)maxWithJavaLangComparable:(id<JavaLangComparable> __nonnull)a
                             withJavaLangComparable:(id<JavaLangComparable> __nonnull)b;

/*!
 @brief Returns the maximum of the two values, according to the given comparator.If the values compare
 ...
 @param a first value to compare, returned if greater than or equal to b.
 @param b second value to compare.
 @throw ClassCastExceptionif the parameters are not <i>mutually comparable</i> using the given
      comparator.
 @since 30.0
 */
...
/*!
 @brief Returns the minimum of the two values.If the values compare as 0, the first is returned.
 <p>The recommended solution for finding the <code>minimum</code> of some values depends on the type
  of your data and the number of elements you have. Read more in the Guava User Guide article on 
 <a href="https://github.com/google/guava/wiki/CollectionUtilitiesExplained#comparators"><code>Comparators</code>
 </a>.
 ...
 @since 30.0
 */
+ (id<JavaLangComparable>)minWithJavaLangComparable:(id<JavaLangComparable> __nonnull)a
                             withJavaLangComparable:(id<JavaLangComparable> __nonnull)b;

/*!
 @brief Returns the minimum of the two values, according to the given comparator.If the values compare
  as equal, the first is returned.
 <p>The recommended solution for finding the <code>minimum</code> of some values depends on the type
  of your data and the number of elements you have. Read more in the Guava User Guide article on 
 <a href="https://github.com/google/guava/wiki/CollectionUtilitiesExplained#comparators"><code>Comparators</code>
