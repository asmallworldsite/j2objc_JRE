...
- (instancetype __nonnull)initWithComGoogleCommonCollectFilteredKeySetMultimap:(ComGoogleCommonCollectFilteredKeySetMultimap * __nonnull)outer$;

// Disallowed inherited constructors, do not use.

- (instancetype __nonnull)initWithComGoogleCommonCollectFilteredKeyMultimap:(ComGoogleCommonCollectFilteredKeyMultimap * __nonnull)outer$ NS_UNAVAILABLE;
