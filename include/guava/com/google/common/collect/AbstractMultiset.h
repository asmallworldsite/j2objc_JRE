...
- (jboolean)addWithId:(id __nullable)element;
...
- (instancetype __nonnull)initWithComGoogleCommonCollectAbstractMultiset:(ComGoogleCommonCollectAbstractMultiset * __nonnull)outer$;
