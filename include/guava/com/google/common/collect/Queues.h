...
/*!
 @brief Drains the queue as drain(BlockingQueue, Collection, int, Duration), but with a
  different behavior in case it is interrupted while waiting.In that case, the operation will
  continue as usual, and in the end the thread's interruption status will be set (no <code>InterruptedException</code>
  is thrown).
 @param q the blocking queue to be drained
 @param buffer where to add the transferred elements
 @param numElements the number of elements to be waited for
...
FOUNDATION_EXPORT jint ComGoogleCommonCollectQueues_drainWithJavaUtilConcurrentBlockingQueue_withJavaUtilCollection_withInt_withJavaTimeDuration_(id<JavaUtilConcurrentBlockingQueue> q, id<JavaUtilCollection> buffer, jint numElements, JavaTimeDuration *timeout);
...
FOUNDATION_EXPORT jint ComGoogleCommonCollectQueues_drainUninterruptiblyWithJavaUtilConcurrentBlockingQueue_withJavaUtilCollection_withInt_withJavaTimeDuration_(id<JavaUtilConcurrentBlockingQueue> q, id<JavaUtilCollection> buffer, jint numElements, JavaTimeDuration *timeout);
