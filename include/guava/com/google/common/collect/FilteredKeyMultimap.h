...
- (id<JavaUtilCollection>)removeAllWithId:(id __nonnull)key;
...
- (jboolean)addWithId:(id __nonnull)v;
...
- (instancetype __nonnull)initWithComGoogleCommonCollectFilteredKeyMultimap:(ComGoogleCommonCollectFilteredKeyMultimap * __nonnull)outer$;
