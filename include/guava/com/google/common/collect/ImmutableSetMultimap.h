...
@endcode
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)flatteningToImmutableSetMultimapWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)keyFunction
...
@endcode
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)toImmutableSetMultimapWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)keyFunction
...
- (ComGoogleCommonCollectImmutableSetMultimap_Builder *)combineWithComGoogleCommonCollectImmutableMultimap_Builder:(ComGoogleCommonCollectImmutableMultimap_Builder * __nonnull)other;
