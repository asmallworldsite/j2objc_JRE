...
//  source: /Users/tball/src/j2objc/guava/build_result/java/com/google/common/collect/ImmutableMultiset.java
//
...
/*!
 ...
 .Elements iterate in order by the <i>first</i> appearance of that element in
  encounter order.
 @since 21.0
 */
...
/*!
 @brief Returns a <code>Collector</code> that accumulates elements into an <code>ImmutableMultiset</code> whose
  elements are the result of applying <code>elementFunction</code> to the inputs, with counts equal to
  the result of applying <code>countFunction</code> to the inputs.
 <p>If the mapped elements contain duplicates (according to <code>Object.equals</code>), the first
...
- (instancetype __nonnull)initWithComGoogleCommonCollectMultiset:(id<ComGoogleCommonCollectMultiset> __nonnull)contents;
...
- (instancetype __nonnull)initWithJavaUtilList:(id<JavaUtilList> __nonnull)entries
            withComGoogleCommonCollectMultiset:(id<ComGoogleCommonCollectMultiset> __nonnull)delegate;
