...
/*!
 ...
 <code>Collections.singleton(Object)</code> and <a href="https://docs.oracle.com/javase/9/docs/api/java/util/Set.html#immutable">
 <code>Set.of</code></a>,
...
/*!
 @brief If this collection is backed by an array of its elements in insertion order, returns it.
 */
- (IOSObjectArray *)internalArray;

/*!
 @brief If this collection is backed by an array of its elements in insertion order, returns the offset
