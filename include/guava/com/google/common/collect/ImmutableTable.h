...
/*!
 ...
 @since 21.0
 */
+ (id<JavaUtilStreamCollector>)toImmutableTableWithJavaUtilFunctionFunction:(id<JavaUtilFunctionFunction> __nonnull)rowFunction
...
- (ComGoogleCommonCollectImmutableTable_Builder *)combineWithComGoogleCommonCollectImmutableTable_Builder:(ComGoogleCommonCollectImmutableTable_Builder * __nonnull)other;
