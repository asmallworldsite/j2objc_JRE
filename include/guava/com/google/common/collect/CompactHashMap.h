...
@interface ComGoogleCommonCollectCompactHashMap : JavaUtilAbstractMap < JavaIoSerializable > {
 @public
  /*!
   @brief Contains the logical entries, in the range of [0, size()).The high bits of each int are the
...
/*!
 ...
 @param expectedSize the initial capacity of this <code>CompactHashMap</code> .
 */
...
- (id<JavaUtilMap> __nullable)delegateOrNull;
